...
include '../conecta.php';
  ...
  $q = "(
	(SELECT  id_libro AS id_material,lib_libros.id_asignatura,lib_libros.id_grado , lib_libros.id_perfil, null AS orden, cat_grado.grado, cat_asignatura.asignatura, null AS id_bloque, null AS secuencia, cat_material.material AS tipo_material,   cat_material.id_tipo_material, lib_libros.titulo_libro AS titulo ,lib_libros.img_libro AS img, lib_libros.ver_libro as url, lib_libros.zip_libro AS exe, null AS orden
		FROM ( 
