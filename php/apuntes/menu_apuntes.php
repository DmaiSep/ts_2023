...
/* Consulta para los grados con su respectiva asignatura para apuntes */

  $q = "SELECT DISTINCT cat_grado.id_grado, cat_grado.grado  
	    FROM (lib_apuntes 
	    INNER JOIN cat_grado ON cat_grado.id_grado = lib_apuntes.id_grado) 
	    WHERE lib_apuntes.estado= 1 ORDER BY `id_grado` ASC;";
